...
$(document).ready(function () {
  ...
  var dataListView = $('.data-posyandu').DataTable({
    responsive: false,
    columnDefs: [{
      orderable: true,
      targets: 0,
  ...
  var dataThumbView = $(".data_posyandu").DataTable({
    responsive: false,
    columnDefs: [{
      orderable: true,
      targets: 0,
  ...
  $(".data-posyandu, .data-posyandu-view").on("click", "tbody td", function () { 
  ...
  $(".data-posyandu, .data-posyandu-view").on("dblclick", "tbody td", function () { 
    $(this).closest("tr").toggleClass("selected");
    var trid = $(this).closest('tr').attr('id');
    var ck = idpos.indexOf(trid);
    if(ck<0){
  ...
  $(".dt-checkboxes-select-all input").on("click", function () {
    $(".data-posyandu").find("tbody tr").toggleClass("selected")
    $(".data-posyandu-view").find("tbody tr").toggleClass("selected")
  })
  // Scrollbar
